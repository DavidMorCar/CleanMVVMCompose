...
import com.davidmoreno.cleanmvvmcompose.view.album.SongListView
            ...
            CleanMVVMComposeTheme {
                Surface(
                    ...
                    NavHost(
                        ...
                        startDestination = Screen.SongListScreen.route
                    ) {
                        composable(route = Screen.SongListScreen.route) {
                            SongListView(navController = navController, context = context)
                        }
